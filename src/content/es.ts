...
export const es: Dictionary = {
  ...
  competition: {
    ...
    prizeHead: { place: "Puesto", prize: "Premio" },
    ...
    viewOnLiquipedia: "Ver en Liquipedia",
    dataFromLiquipedia: "Datos: Liquipedia",
    liquipediaLogoSource: "Archivo del logo / licencia",
  },
  ...
  roadmap: {
    ...
    lede: "El circuito 2026 ya está trazado: tres etapas con premio confirmado, de septiembre a diciembre.",
